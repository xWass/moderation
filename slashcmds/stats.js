...
module.exports = {
    ...
    async execute(interaction) {
        console.log(
            `${chalk.greenBright(
                "[EVENT ACKNOWLEDGED]"
            )} interactionCreate with command stats`
        );
        ...
        const embed = new MessageEmbed()
            ...
            .addFields(
                {
                    name: "Servers :computer:",
                    value: `\`\`\`${guildsCount}\`\`\``,
                    inline: true,
                },
                {
                    name: "Users :family_mmbb:",
                    value: `\`\`\`${usersCount}\`\`\``,
                    inline: true,
                },
                {
                    name: "API Latency :ping_pong:",
                    value: `\`\`\`${interaction.client.ws.ping}ms\`\`\``,
                    inline: true,
                },
                {
                    name: "Discord.js :tools:",
                    value: "```13.12.0```",
                    inline: true,
                },
                {
                    name: "CPU Usage :bar_chart:",
                    value: `\`\`\`${await cpu.usage()} %\`\`\``,
                    inline: true,
                },
                {
                    name: "Uptime :green_circle:",
