          ...
          fields: [
            {
              name: "Verification",
              value:
                "Select Verification to enable/modify server verification on member join.",
              inline: true
            },
            {
              name: "Automod",
              value:
                "Select Automod to enable/modify this server's automatic moderation strictness",
              inline: true
            },
            {
              name: "Logging",
              value:
                "Select logging to enable/modify this server's logging strictness.",
              inline: true
            }
          ],
          footer: {
